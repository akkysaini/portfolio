  ...
  return (
    ...
    >
      ...
      <p className="mb-3 text-justify">
        ...
        a responsive and visually stunning website. I{" "}
        <span className="underline">love</span> the feeling of figuring out a
        solution to the errors in a website. My core skills are
        <span className="font-medium">
          {" "}
          HTML, CSS, JavaScript and Wordpress
        </span>
        . I am also familiar with{" "}
        <span className="font-medium"> React, Next.js </span>and other
        <span className="italic"> CSS frameworks </span>like
        <span className="font-medium"> Tailwind CSS </span>and
        <span className="font-medium"> Bootstrap</span>. I am currently looking
