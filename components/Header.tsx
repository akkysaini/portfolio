        ...
        <ul className='flex  w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
           {
            links.map(({hash,name}) => (
                ...
                >
                <Link 
                className={clsx('flex w-full items-center justify-center hover:text-gray-950 p-3  transition dark:text-gray-500 dark:hover:text-gray-300', {"text-gray-950 dark:text-gray-300": activeSection === name,})} 
                href={hash}
