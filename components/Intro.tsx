...
export default function Intro() {
  return (
    <section className='mb-28 max-w-[50rem] text-center'>
        ...
        <motion.h1
        className="mb-10 mt-4 px-4 text-2xl font-light !leading-[1.5] sm:text-3xl"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-medium">Hello, I'm Akash.</span> I'm a{" "}
        <span className="font-medium">frontend developer</span> with{" "}
        <span className="font-medium">1.5 years</span> of experience. I enjoy
